...
Throughout the LiveCode we will also be using the same HTML document in our exercise. This document has three important pieces:
- A form for adding new books
- A table of existing books
- An underscore template representing a single book
