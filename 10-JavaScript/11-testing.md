...
Just be aware that you'll need to change the:  `module.exports = Scrabble;` in your scrabble.js file to:  `export default Game;`  This is because we're using webpack framework we set up for Backbone.
